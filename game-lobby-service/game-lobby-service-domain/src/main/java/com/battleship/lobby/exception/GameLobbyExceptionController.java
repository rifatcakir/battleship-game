...
public class GameLobbyExceptionController {
    ...
    @ExceptionHandler(GameLobbyNotFoundException.class)
    public ResponseEntity<ErrorMessage> gameLobbyNotFoundException(GameLobbyNotFoundException ex, WebRequest request) {
        ErrorMessage message = new ErrorMessage(
